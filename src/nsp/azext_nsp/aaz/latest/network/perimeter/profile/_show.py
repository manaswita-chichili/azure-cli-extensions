...
class Show(AAZCommand):
    ...
    :example: Get a network security perimeter profile
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NetworkSecurityPerimeterProfilesGet(ctx=self.ctx)()
    ...
    class NetworkSecurityPerimeterProfilesGet(AAZHttpOperation):
