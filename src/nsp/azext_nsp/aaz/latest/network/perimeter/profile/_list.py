...
class List(AAZCommand):
    ...
    :example: List all network security perimeter profiles
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NetworkSecurityPerimeterProfilesList(ctx=self.ctx)()
    ...
    class NetworkSecurityPerimeterProfilesList(AAZHttpOperation):
