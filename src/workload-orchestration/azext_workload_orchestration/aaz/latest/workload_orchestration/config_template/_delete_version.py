...
class DeleteVersion(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/configtemplates/{}/deleteversion", "2026-03-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ConfigTemplatesDeleteVersion(ctx=self.ctx)()
    ...
    class ConfigTemplatesDeleteVersion(AAZHttpOperation):
