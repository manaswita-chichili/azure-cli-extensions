...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/Microsoft.Edge/configtemplates", "2026-03-01"],
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.ConfigTemplatesListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.ConfigTemplatesListByResourceGroup(ctx=self.ctx)()
    ...
    class ConfigTemplatesListBySubscription(AAZHttpOperation):
    ...
    class ConfigTemplatesListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
