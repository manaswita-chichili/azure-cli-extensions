...
class Show(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/configtemplates/{}/versions/{}", "2026-03-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ConfigTemplateVersionsGet(ctx=self.ctx)()
    ...
    class ConfigTemplateVersionsGet(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "configTemplateVersionName", self.ctx.args.config_template_version_name,
                    required=True,
                ),
                **self.serialize_url_param(
