...
class DeleteVersion(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/solutiontemplates/{}/deleteversion", "2026-03-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.SolutionTemplatesDeleteVersion(ctx=self.ctx)()
    ...
    class SolutionTemplatesDeleteVersion(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/solutionTemplates/{solutionTemplateName}/deleteVersion",
                **self.url_parameters
            )
...
class _DeleteVersionHelper:
    """Helper class for DeleteVersion"""


__all__ = ["DeleteVersion"]
