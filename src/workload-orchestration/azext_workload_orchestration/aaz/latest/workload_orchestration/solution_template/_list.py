...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/Microsoft.Edge/solutiontemplates", "2026-03-01"],
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.SolutionTemplatesListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.SolutionTemplatesListByResourceGroup(ctx=self.ctx)()
    ...
    class SolutionTemplatesListBySubscription(AAZHttpOperation):
    ...
    class SolutionTemplatesListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
