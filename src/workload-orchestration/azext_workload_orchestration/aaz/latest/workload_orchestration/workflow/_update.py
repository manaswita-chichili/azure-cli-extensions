...
class Update(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/workflows/{}", "2026-03-01"],
        ]
    }
    ...
    class WorkflowsGet(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/workflows/{workflowName}",
                **self.url_parameters
            )
...
class _UpdateHelper:
    ...
    def _build_schema_workflow_read(cls, _schema):
        if cls._schema_workflow_read is not None:
            _schema.e_tag = cls._schema_workflow_read.e_tag
            _schema.extended_location = cls._schema_workflow_read.extended_location
            ...
            _schema.system_data = cls._schema_workflow_read.system_data
        ...
        workflow_read.e_tag = AAZStrType(
            serialized_name="eTag",
            flags={"read_only": True},
        )
        workflow_read.extended_location = AAZObjectType(
        ...
        workflow_read.system_data = AAZObjectType(
        ...
        extended_location = _schema_workflow_read.extended_location
        ...
        system_data = _schema_workflow_read.system_data
