...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkflowVersionsListByWorkflow(ctx=self.ctx)()
    ...
    class WorkflowVersionsListByWorkflow(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/workflows/{workflowName}/versions",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            stage_spec = cls._schema_on_200.value.Element.properties.stage_spec
            stage_spec.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.stage_spec.Element
            _element.name = AAZStrType(
                flags={"required": True},
            )
