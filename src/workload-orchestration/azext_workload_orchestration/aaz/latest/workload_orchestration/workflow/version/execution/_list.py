...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ExecutionsListByWorkflowVersion(ctx=self.ctx)()
    ...
    class ExecutionsListByWorkflowVersion(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/workflows/{workflowName}/versions/{versionName}/executions",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            stage_history = cls._schema_on_200.value.Element.properties.status.stage_history
            stage_history.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.status.stage_history.Element
