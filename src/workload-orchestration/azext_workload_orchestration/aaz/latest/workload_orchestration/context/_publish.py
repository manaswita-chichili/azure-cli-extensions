...
class Publish(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/contexts/{}/publish", "2026-03-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ContextsPublish(ctx=self.ctx)()
    ...
    class ContextsPublish(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/contexts/{contextName}/publish",
                **self.url_parameters
            )
        ...
        def content(self):
            ...
            _builder.set_prop("workflowName", AAZStrType, ".workflow_name")
