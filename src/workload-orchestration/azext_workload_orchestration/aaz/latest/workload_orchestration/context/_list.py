...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/Microsoft.Edge/contexts", "2026-03-01"],
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/contexts", "2026-03-01"],
        ]
    }
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.ContextsListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.ContextsListByResourceGroup(ctx=self.ctx)()
    ...
    class ContextsListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            hierarchies = cls._schema_on_200.value.Element.properties.hierarchies
            hierarchies.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.hierarchies.Element
            _element.description = AAZStrType(
                flags={"required": True},
            )
            _element.name = AAZStrType(
    ...
    class ContextsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
