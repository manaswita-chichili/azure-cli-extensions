...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/Microsoft.Edge/diagnostics", "2026-03-01"],
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.DiagnosticsListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.DiagnosticsListByResourceGroup(ctx=self.ctx)()
    ...
    class DiagnosticsListBySubscription(AAZHttpOperation):
