...
class Update(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/diagnostics/{}", "2026-03-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.diagnostic_name = AAZStrArg(
            options=["-n", "--name", "--diagnostic-name"],
            help="Name of Diagnostic.",
            required=True,
            id_part="name",
            fmt=AAZStrArgFormat(
    ...
    def _execute_operations(self):
        ...
        yield self.DiagnosticsCreateOrUpdate(ctx=self.ctx)()
    ...
    class DiagnosticsGet(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "diagnosticName", self.ctx.args.diagnostic_name,
                    required=True,
                ),
                **self.serialize_url_param(
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_diagnostic_read(cls._schema_on_200)

            return cls._schema_on_200

    class DiagnosticsCreateOrUpdate(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_diagnostic_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_diagnostic_read = None

    @classmethod
    def _build_schema_diagnostic_read(cls, _schema):
        if cls._schema_diagnostic_read is not None:
        ...
        cls._schema_diagnostic_read = _schema_diagnostic_read = AAZObjectType()

        diagnostic_read = _schema_diagnostic_read
        diagnostic_read.e_tag = AAZStrType(
            serialized_name="eTag",
            flags={"read_only": True},
        )
        diagnostic_read.extended_location = AAZObjectType(
        ...
        diagnostic_read.properties = AAZObjectType()
        diagnostic_read.system_data = AAZObjectType(
        ...
        extended_location = _schema_diagnostic_read.extended_location
        ...
        properties = _schema_diagnostic_read.properties
        properties.provisioning_state = AAZStrType(
            serialized_name="provisioningState",
            flags={"read_only": True},
        )

        system_data = _schema_diagnostic_read.system_data
