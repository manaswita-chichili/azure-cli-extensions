...
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/Microsoft.Edge/targets", "2026-05-01-preview"],
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/targets", "2026-05-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.TargetsListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.TargetsListByResourceGroup(ctx=self.ctx)()
    ...
    class TargetsListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            target_statuses = cls._schema_on_200.value.Element.properties.status.target_statuses
            target_statuses.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.status.target_statuses.Element
            ...
            component_statuses = cls._schema_on_200.value.Element.properties.status.target_statuses.Element.component_statuses
            component_statuses.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.status.target_statuses.Element.component_statuses.Element
            _element.name = AAZStrType()
            _element.status = AAZStrType()
    ...
    class TargetsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
