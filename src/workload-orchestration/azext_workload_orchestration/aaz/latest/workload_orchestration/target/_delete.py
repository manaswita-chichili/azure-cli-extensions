...
@register_command(
    "workload-orchestration target delete",
...
class Delete(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/targets/{}", "2026-03-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.TargetsDelete(ctx=self.ctx)()
    ...
    class TargetsDelete(AAZHttpOperation):
