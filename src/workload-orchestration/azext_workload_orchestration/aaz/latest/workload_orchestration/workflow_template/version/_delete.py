...
class Delete(AAZCommand):
    """Delete a Workflow Template Version Resource
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.WorkflowTemplateVersionsDelete(ctx=self.ctx)()
    ...
    class WorkflowTemplateVersionsDelete(AAZHttpOperation):
