...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/workflowtemplates/{}/versions", "2026-03-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.WorkflowTemplateVersionsListByWorkflowTemplate(ctx=self.ctx)()
    ...
    class WorkflowTemplateVersionsListByWorkflowTemplate(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            stage_spec_template = cls._schema_on_200.value.Element.properties.stage_spec_template
            stage_spec_template.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.stage_spec_template.Element
            _element.name = AAZStrType(
                flags={"required": True},
            )
