...
class RemoveVersion(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Edge/schemas/{}/removeversion", "2026-03-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SchemasRemoveVersion(ctx=self.ctx)()
    ...
    class SchemasRemoveVersion(AAZHttpOperation):
