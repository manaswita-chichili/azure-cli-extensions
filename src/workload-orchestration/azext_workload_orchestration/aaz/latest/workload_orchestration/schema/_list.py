...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/Microsoft.Edge/schemas", "2026-03-01"],
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.SchemasListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.SchemasListByResourceGroup(ctx=self.ctx)()
    ...
    class SchemasListBySubscription(AAZHttpOperation):
    ...
    class SchemasListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
